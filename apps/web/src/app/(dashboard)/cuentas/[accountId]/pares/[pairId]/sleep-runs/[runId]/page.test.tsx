...
vi.mock("next/navigation", () => ({
  usePathname: () =>
    "/cuentas/00000000-0000-0000-0000-000000000000/pares/11111111-1111-1111-1111-111111111111/sleep-runs/22222222-2222-2222-2222-222222222222",
}));
  ...
  it("renders every section from a populated report", async () => {
    ...
    render(
      <Suspense fallback={<div>L</div>}>
        <SleepRunReportPage
          params={resolvedParams({ accountId: ACCOUNT_ID, pairId: PROJECT_ID, runId: RUN_ID })}
        />
      </Suspense>,
    );
    ...
    expect(beforeLink).toHaveAttribute(
      "href",
      `/cuentas/${ACCOUNT_ID}/pares/${PROJECT_ID}/q-tables#v4`,
    );
    expect(afterLink).toHaveAttribute(
      "href",
      `/cuentas/${ACCOUNT_ID}/pares/${PROJECT_ID}/q-tables#v5`,
    );
